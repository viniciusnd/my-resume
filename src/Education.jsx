...
export default function Education() {
  return (
    <div className="min-h-screen bg-red-700">
      ...
      <header className="text-white text-center font-playfair mt-5 text-3xl uppercase"> Education </header>
      <div className="text-white text-left text-lg flex flex-col ml-5 mt-5 md:text-center">
        <p1 className="flex flex-row mt-5 font-bold">Technical Degree:</p1>
        <ul className="ml-5 text-base mt-3 flex flex-col md:flex-col md:text-lg md:text-left space-x-0 space-y-0">
        ...
        <ul className="ml-5 text-base mt-3 flex flex-col md:flex-col md:text-lg md:text-left">
        ...
        <ul className="ml-5 text-base mt-3 mb-5 flex flex-col md:flex-col md:text-lg md:text-left">
        ...
        <ul className="ml-5 text-base mt-3 mb-5 flex flex-col md:flex-col md:text-lg md:text-left">
          ...
          <li>- For more details of what I am studying go to <a href="/skills">"Skills"</a></li>
        </ul>
      </div>
    </div>
  )
