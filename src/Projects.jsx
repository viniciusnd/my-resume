...
export default function Projects() {
  return (
    <div className="min-h-screen bg-red-700">
      ...
      <header className="text-white text-center font-playfair mt-5 text-3xl uppercase"> Projects </header>
      <div className="text-white text-left text-lg flex flex-col ml-5 mt-5 md:text-center">
        ...
        <ul className="ml-5 text-base mt-3 mb-5 flex flex-col md:flex-col md:text-lg md:text-left">
          ...
          <li className="flex flex-row mt-3">- GitHub: <a href="https://github.com/viniciusnd" className="text-xl text-gray-300 ml-3"><ion-icon name="logo-github"></ion-icon></a></li>
