  ...
  return (
    <div className="min-h-screen bg-alana-700">
      ...
      <div className="text-white text-left text-sm md:text-base flex flex-col ml-5 mt-5 md:text-center">
        <p4 className="flex flex-row mt-5 font-bold">Segula Technologies:</p4>
        <ul className="ml-5 text-sm md:text-base mt-3 flex flex-col mb-3 md:flex-col md:text-left mr-5 md:mr-3">
          <li>- Role: Product Specialist || Software Engineer | May 2023 - Present</li>
          <li>- Activities: Functional Analysis | Interpretation of Software Requirements| Developing Algorithms and Models | Simulation, Validation, Integration, Corrections, Evolutions and Versioning of Software</li>
          <li>- Tech: MIL, SIL, Matlab, Simulink, Model Based Design, CAN, LIN, C, C++, SCRUM, Engines Systems</li>
        </ul>
        ...
        <ul className="ml-5 text-sm md:text-base mt-3 flex flex-col mb-3 md:flex-col md:text-left">
          <li>- Role: Software Engineer | Aug 2022 - May 2023</li>
          <li>- Activities: Software test and validation | Process Development | Creation and Management of Reports</li>
          <li>- Tech: Unit Test, SIL, Matlab, Simulink, CAN, Infotainment Systems, C, C++, Python, SCRUM, Code Coverage, GIT, JIRA</li>
        </ul>
        ...
        <ul className="ml-5 text-sm md:text-base mt-3 flex flex-col md:flex-col md:text-left mb-5">
